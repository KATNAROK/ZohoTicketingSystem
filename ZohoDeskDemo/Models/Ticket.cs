...
{
    public class Ticket
    {//Some of these attributes should be in a seperate class as they pertain to the created ticket's return details.
    ...
    public class TicketManager
    {
        public string TicketPostResponse(FormDetails footageRequestDetails)
        {
            ...
            toSend.subject = "New Subject line, updated by Riccardo! :" + DateTime.Now;
            ...
            var stringResponse = "CONGRATULATIONS! YOUR TICKET WAS CREATED!" + "\n" + "ID: " + t.id + "\n" + "Contact ID: " + t.contactId + "\n" + "Ticket Number: " + t.ticketNumber + "\n" + "Subject: " + t.subject + "\n" + "Description: " + t.description + "\n" + "Email: " + t.email + "\n" + "Priority: " + t.priority + "\n" + "Channel: " + t.channel + "\n" + "Status: " + t.status;
